...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: "公司动态",
        link: "https://aiflowy.tech/articles",
        noIcon: true,
        target: "_self",
      },
      {
        text: "关于我们",
        link: "https://aiflowy.tech/about",
        noIcon: true,
        target: "_self",
      },
    ],
  ...
  head: [
    ...
    [
      ...
      (function() {
        ...
        hm.src = "https://hm.baidu.com/hm.js?5141db886aac60569180f65b216f6863";
    ...
    },
    {
      ...
      items: [
        ...
        { text: "文件管理", link: "backend/file_management" },
        {
          text: "工作流",
          collapsed: false,
          items: [{ text: "自定义节点", link: "ai/custom-node" }],
        },
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: "挂载MCP", link: "bot-application/mount-mcp" },
            // {
          ...
          items: [
            ...
            { text: "Embedding 模型", link: "knowledge/embedding" },
            {
              ...
              items: [
                ...
                {
                  text: "openSearch",
                  link: "knowledge/vector-database/opensearch.md",
                },
